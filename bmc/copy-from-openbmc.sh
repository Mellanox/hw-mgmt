...
cp "$A/71-hw-management-events.rules" "$BD/usr/etc/HI193/71-hw-management-bmc-events.rules"

# Platform HI193 (add prefix for config files)
cp "$A/a2d_leakage_config.json" "$BD/usr/etc/HI193/hw-management-bmc-a2d-leakage-config.json"
cp "$A/platform_config" "$BD/usr/etc/HI193/hw-management-bmc-platform.conf"
...
cp "$A/spc6-ast2700-a1-hw-management-events.sh" "$BD/usr/etc/HI193/hw-management-bmc-events.sh"
chmod +x "$BD/usr/etc/HI193/hw-management-bmc-events.sh"
...
# (spc6-ast2700-a1-hw-management-events.sh copied to etc/HI193/hw-management-bmc-events.sh above)
