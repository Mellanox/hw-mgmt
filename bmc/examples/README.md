...
| [hw-management-bmc-thermal-sysfs.txt](hw-management-bmc-thermal-sysfs.txt) | **Index pointer** to per-HID thermal examples (see below). |
| [HI189/examples/hw-management-bmc-thermal-sysfs.txt](HI189/examples/hw-management-bmc-thermal-sysfs.txt) | **HI189** `/var/run/hw-management/thermal/` symlinks (CPU `sbtsi`, BMC `lm75`). |
