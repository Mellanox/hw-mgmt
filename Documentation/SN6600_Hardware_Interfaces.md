...
| `config/fan_drwr_num` | Fan drawer count (runtime) | **5** at init; updated by `hw-management-thermal-events.sh` when mlxreg fan hwmon appears |
...
|------|---------|---------------|--------------|
| `config/psu1_i2c_bus` / `config/psu1_i2c_addr` | 6 | 0x59 | `dps460` → `psu1` |
| `config/psu2_i2c_bus` / `config/psu2_i2c_addr` | 6 | 0x58 | `dps460` → `psu2` |
| `config/psu3_i2c_bus` / `config/psu3_i2c_addr` | 6 | 0x5b | `dps460` → `psu3` |
| `config/psu4_i2c_bus` / `config/psu4_i2c_addr` | 6 | 0x5a | `dps460` → `psu4` |
