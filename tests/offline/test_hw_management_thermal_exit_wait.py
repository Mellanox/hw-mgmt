...
#
# Unit tests for hw_management_lib.exit_wait() (Bug 4946747; original chunked-wait fix 4879247):
# Chunked Event.wait so the main thread returns to the interpreter and SIGTERM handlers run before systemd TimeoutStopSec.
################################################################################
